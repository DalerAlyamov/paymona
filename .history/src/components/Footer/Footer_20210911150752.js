    ...
    <div className={styles.root}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.AboutCompany}>
          ...
          <Link to='/' className={styles.servicesItems}>Г. Душанбе</Link>
          <Link to='/' className={styles.servicesItems}>ул. Мирзо Турсунзода 40</Link>
          <Link to='/' className={styles.servicesItems}>Телефон: 88-444-73-75</Link>
          <Link to='/' className={styles.servicesItems}>Office@paymona.com</Link>
        </div>
